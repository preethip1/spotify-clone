<div>
  <div class="flex flex-col h-screen text-sm text-gray-300">
      ...
      >
        <ul class="py-6">
            ...
            <a href="#" class="flex items-center mx-4 mt-4">
              <span
                ><svg
                  ...
                  width="24"
                  height="24"
                  class="fill-current text-white group-hover:text-white h-6 w-6"
                  ><path
          ...
          <li class="border-l-4 border-transparent">
            <a href="#" class="flex items-center hover-text-white mx-4 mt-4">
              <svg
                width="24"
                height="24"
                class="fill-current text-gray-400 h-6 w-6"
          ...
          <li class="border-l-4 border-transparent">
            <a href="#" class="flex items-center hover-text-white mx-4 mt-4">
              <svg
                viewBox="0 0 24 24"
                class="fill-current text-gray-400 h-6 w-6 group-hover:text-white"
                ><g data-name="Layer 2"
                  ><g data-name="radio"
                    ><path
        ...
        <div class="overflow-y-auto px-4 mt-2">
          ...
          <ul class="leading-loose">
            ...
            <li class="truncate">
              <a href="#" class="hover-text-white">Recently added</a>
            </li>
            <li class="truncate">
        ...
        <div class="border-t border-gray-800 h-16 px-4 py-2 flex items-center">
          <svg
            viewBox="0 0 24 24"
            width="24"
            height="24"
            class="fill-current text-gray-600 w-8 h-8 group-hover:text-white"
            ><path
            ...
            /></svg
          >
          <a href="#" class="font-normal text-gray-500 ml-2 hover-text-white"
            >New Playlist</a
          >
        </div>
      </div>
      <div class="content-area bg-gray-700 flex-1  flex flex-col">
        <div class="top-bar flex items-center justify-between px-4 py-2">
          <div class="flex items-center">
            <button class=" border-none"
              ><svg
                ...
                ><path
                  d="M14.7 15.3a1 1 0 01-1.4 1.4l-4-4a1 1 0 010-1.4l4-4a1 1 0 011.4 1.4L11.42 12l3.3 3.3z"
                /></svg
              ></button
            >
            <button class="ml-1  border-none"
              ><svg
                viewBox="0 0 24 24"
                width="24"
                height="24"
          ...
          <div class="flex items-center">
            <button
              ...
              ></button
            >
            <a href="#" class="ml-2 hover:underline hover:text-white">Preethi</a
            >
            <button class="ml-4"
              ><svg
                viewBox="0 0 24 24"
        ...
        <div class="overflow-y-auto">
          <div>
            ...
            <div class="mt-10">
              <h3 class="border-b border-gray-900 font-semibold text-xl pb-2">
                Recently Played
              </h3>
              <div class="flex items-center mt-4 -mx-4 overflow-y-hidden">
                <div class="w-1/5 px-4">
                  <div>
                    <a href="#"
                      ><img
                        src="https://tailwind-v1-examples.netlify.app/albumcover02.jpg"
                        alt="album cover"
                      /></a
                    >
                  </div>
                  <div>
                    <a
                      href="#"
                      class="font-semibold block hover:text-white mt-2 "
                      >Acoustic Pop Covers</a
                    >
                    <div class="text-gray-400 mt-2">
                      Amazing Covers updated every week
                    </div>
                    <div class="tracking-widest text-xs text-gray-400">
                      8989 Followers
                    </div>
                  </div>
                </div>
                ...
                <div class="w-1/5 px-4">
                  <div>
                    <a href="#"
                      ><img
                        src="https://tailwind-v1-examples.netlify.app/albumcover03.jpg"
                        alt="album cover"
                      /></a
                    >
                  </div>
                ...
                <div class="w-1/5 px-4">
                  <div>
                    <a href="#"
                      ><img
                        src="https://tailwind-v1-examples.netlify.app/albumcover01.jpg"
                        alt="album cover"
                      /></a
                    >
                  </div>
              ...
              <div class="flex items-center mt-4 -mx-4 overflow-y-hidden">
                ...
                <div class="w-1/5 px-4">
                  <div>
                    <a href="#"
                      ><img
                        src="https://tailwind-v1-examples.netlify.app/albumcover04.jpg"
                        alt="album cover"
                      /></a
                    >
                  </div>
                ...
                <div class="w-1/5 px-4">
                  <div>
                    <a href="#"
                      ><img
                        src="https://tailwind-v1-examples.netlify.app/albumcover05.jpg"
                        alt="album cover"
                      /></a
                    >
                  </div>
    ...
    <div
      class="bg-gray-600 flex-none h-24 px-5 flex items-center justify-between"
    >
      <div class="flex items-center justify-between ">
        ...
        <div class="ml-3">
          <div>
            <a href="#" class="text-xs text-gray-300 hover-text-white"
              >Name of the song</a
            >
          </div>
          <div>
      ...
      <div class="player-controls flex flex-col justify-center">
        <div class="flex justify-center border-none">
          <button class="border-none text-white"
            ><svg
              viewBox="0 0 20 20"
            ...
            ></button
          >
          <button class="ml-8 border-none text-white"
            ><svg
              viewBox="0 0 20 20"
              class="fill-current text-gray-400 hover:text-white h-6 w-6"
        ...
        <div class="max-w-full mt-3 flex items-center justify-center">
          ...
          <div class="bg-gray-500 rounded-lg w-full xl:w-200 h-1 ml-3" />
      ...
      <div class="volume-controls flex items-center">
        <button class="border-none text-white"
          ...
          ></button
        >
        <button class="ml-4 border-none text-white"
          ><svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
        ...
        <button class="ml-4 border-none text-white"
          ...
          ></button
        >
        <div class="bg-gray-500 rounded-lg w-20 h-1 ml-3" />
        <button class="ml-4 border-none text-white"
          ><svg
            width="24"
            height="24"
